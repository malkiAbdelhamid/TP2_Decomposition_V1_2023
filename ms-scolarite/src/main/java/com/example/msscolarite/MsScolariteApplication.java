...
public class MsScolariteApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        etudiantRepository.save(new Etudiant(null,"malki", Date.valueOf("1999-01-01"),"4isi",null,e1,1L));
        etudiantRepository.save(new Etudiant(null,"ali", Date.valueOf("1995-08-11"),"4siw",null,e1,1L));
        etudiantRepository.save(new Etudiant(null,"karim", Date.valueOf("1996-11-22"),"MatserSiC",null,e2,2L));
        etudiantRepository.save(new Etudiant(null,"fouad", Date.valueOf("2000-02-15"),"MasterSiR",null,e2,2L));
